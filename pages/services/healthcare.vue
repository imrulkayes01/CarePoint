            ...
            <div class=" max-w-[1280px] mx-auto items-center px-5 lg:pt-[8rem] pt-[8rem] lg:pb-[4rem] pb-[3.5rem]">
                <div class="text-center pt-[0rem]">
                    <h1
                        ...
                        <span class="text-[#000]">Apparel Care & Wardobe Solutions 5</span>
                    </h1>
                    ...
                    <div class="max-w-[800px] mx-auto mt-8">
                        <div class="relative bg-white rounded-[25px] shadow-sm border border-gray-200">
                            <div class="flex items-center px-4 py-1 lg:py-[8px]">
                                ...
                                <button
                                    class="bg-red-400 hover:bg-red-500 text-white px-4 py-2 rounded-lg ml-4 transition-colors">
                                    Search
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-center space-x-3 mt-4">
                            <button
                                class="bg-white rounded-lg px-3 lg:px-[1rem] py-2 text-gray-600 font-medium shadow-sm border border-gray-200 hover:bg-gray-200 transition-colors">
                                Delectest
                            </button>
                            <button
                                class="bg-white rounded-lg px-3 lg:px-[1rem]  py-2 text-gray-600 font-medium shadow-sm border border-gray-200 hover:bg-gray-200 transition-colors">
